...
from .views import AjaxListView, TableAsJSON, AjaxCrearView, AjaxEditarView, AjaxEliminarView, AjaxSegurocostoCrear, AjaxSeguroCostoEliminar
...
urlpatterns = [
  ...
  path('segurocosto-ajax-eliminar/<pk>/', login_required(AjaxSeguroCostoEliminar.as_view()), name='segurocosto-ajax-eliminar'),
]