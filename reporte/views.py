...
def reporte_particulares_index(request):
    return render(request, 'reporte/particulares.html')

def reporte_seguros_index(request):
    return render(request, 'reporte/seguros.html')
