...
const waypointContainer = document.getElementById("tabla-seguros");
const ingSeguro = document.getElementById("filtro-seguro");
...
const filtroFechas = () => {    
    let fechaValues = {
        ...
        'seguroini': ingSeguro.value
    }
    fetch('/administracion/ingresos-seguro-filtro/?' + new URLSearchParams(fechaValues))
    .then(res => res.text())
    .then(text => {
...
ingSeguro.addEventListener('change', () => {
    filtroFechas();
})